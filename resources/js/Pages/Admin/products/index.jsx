...
return <img src={item.brandimage.preview_url} alt={item.title} className='w-6rem shadow-2 border-round'/>
   }
    return (
        <AuthenticatedLayout
            user={auth.user}
        ...
        >
            ...
            <div className="py-12">
                ...
                <div className="card">
                <DataTable value={products} paginator rows={10} dataKey="id" filterDisplay="row">
